...
PROJECT_O=SemanticDictionary.o SemanticDescriptor.o SemanticWindow.o
...
EXE=lab2 #Change the executable name as needed

default : main.o $(PROJECT_O) $(GUI_O)
	$(CXX) -g main.o $(PROJECT_O) $(GUI_O) $(LDFLAGS) $(LDLIBS) -o $(EXE)
main.o : main.cpp SemanticDictionary.h
	$(CXX) $(CXXFLAGS) $(CXXFLAGS2) main.cpp
SemanticWindow.o : SemanticWindow.cpp SemanticWindow.h
	$(CXX) $(CXXFLAGS) $(CXXFLAGS2) SemanticWindow.cpp
